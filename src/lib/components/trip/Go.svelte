<script lang="ts">
    ...
    const options: { [key: string]: goOption } = {
        'large': { // Large arrow with icon vertically below
            arrowSize: bigArrow,
            label: '',
            icon: mapIcon,
        ...
        'start': { // Small arrow with label and icon below the label
            arrowSize: smallArrow,
            label: 'เริ่มเส้นทาง',
            icon: mapIcon,
            showArrowBelow: true,
        ...
        'end': { // Small arrow with label and icon above the label
            arrowSize: smallArrow,
            label: 'กลับบ้าน',
            icon: mapIcon,
            showArrowBelow: false,
