...
<button class="m-1 focus:outline-none" disabled={can} on:click={()=>{copyPopupShow =true}}>
...
<Popup bind:isOpen={copyPopupShow} hideCloseBtn={true}>
    ...
    <div class="flex gap-2">
        {#if confirm}
            <div class="flex flex-col">
                ...
                <h2>คุณสามารถเข้าไปดูใน ที่จัดเก็บของคุณได้ และสามารถเข้ามาคัดลอกอีกครั้ง ในครั้งถัดไป</h2>
            </div>
    ...
    <div class="flex items-center gap-4 justify-center mt-4">
        <button on:click={()=>{copyPopupShow = false}}>
            <ButtonMine>
                ปิด
            </ButtonMine>
        </button>
