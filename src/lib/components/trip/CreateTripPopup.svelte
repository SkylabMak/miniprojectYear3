<script lang="ts">
    ...
    <button on:click={()=>{createTripShowPopup = true}}>
        <ButtonMine>
            สร้างทริป
        </ButtonMine>
    </button>
    ...
    <Popup isOpen={createTripShowPopup} hideCloseBtn={true} background={"bg-secondary4"}>
        <div class="bg-secondary4 w-fit rounded-xl flex flex-col gap-4 p-1">
                        ...
                        <div class="flex justify-center items-center gap-8">
                            ...
                            <div class={`flex gap-2 rounded-full`}>
                                <label class="flex items-center">
                                    <input type="radio" name="public" value={true} bind:group={bookingChoice} class="hidden" />
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="public" value={false} bind:group={bookingChoice} class="hidden" />
            ...
            <div class="flex justify-center mt-5 gap-4">
                ...
                <button on:click={createAction} class="bg-accent2 text-white px-4 py-2 rounded-md hover:bg-gray-900 transition-all">สร้าง</button>
            </div>
        </div>
    </Popup>
